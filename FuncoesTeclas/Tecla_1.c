...
void animacao_1(PIO pio, uint sm) {
    ...
    const uint32_t frame3[NUM_PIXELS] = {
        ...
        0x00000000, 0x00000000, 0x00000000, 0x0000FF00, 0x0000FF00, 
    ...
    const uint32_t frame4[NUM_PIXELS] = {
        ...
        0x00000000, 0x00000000, 0x0000FF00, 0x0000FF00, 0x0000FF00,
        0x0000FF00, 0x0000FF00, 0x00000000, 0x00000000, 0x00000000,
        0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x0000FF00
    };

    const uint32_t frame5[NUM_PIXELS] = {
        0x0000FF00, 0x00000000, 0x00000000, 0x00000000, 0x0000FF00,
